...
:: This is simple windows flashing script for Sony Xperia Loire device
...
echo(
echo This is a Windows flashing script for Sony Xperia Loire device.
echo(
...
echo "Software binaries for AOSP Pie (Android 9.0) - Kernel 4.9 - Loire"
